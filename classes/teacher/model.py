...
class TeacherModel(BaseModel):
    ...
    def _start_workers(self, done_chunk, num_inference_workers, made_distributions, model_loaded, start_inference, inference_queue, result_queue, disk_queue, pbar_queue, dataset_chunk: list[ConvoTokenized]):
        ...
        return batch_creator, inference_workers, result_processor
    
    def _stop_workers(self, batch_creator: multiprocessing.Process, inference_workers: list[multiprocessing.Process], result_processor: multiprocessing.Process):
