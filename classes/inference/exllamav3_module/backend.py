"""ExLlamaV3 inference backend - main process side."""
import queue
import threading
...
from classes.inference.exllamav3_module.worker import inference_worker
from utils.inference_utils import num_gpus, get_vram_free


class ExLlamaV3Backend(InferenceBackend):
    def __init__(
        self,
        model_path: str,
        context_len: int,
...
register_backend("exllamav3", ExLlamaV3Backend)
